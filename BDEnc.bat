...
REM x265 settings
set x265_720=avs4x26x -L "x265" --preset slower --crf 16.0 --input-depth 16 --recon-depth 10 --log-level none --output "720_hevc.mkv" "720.avs"
set x265_1080=avs4x26x -L "x265" --preset slower --crf 16.0 --input-depth 16 --recon-depth 10 --log-level none --output "1080_hevc.mkv" "1080.avs"
